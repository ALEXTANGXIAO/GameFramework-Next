...
namespace UnityGameFramework.Editor
{
    ...
    public class CommandLineReader
    {
        ...
        public static Dictionary<string, string> GetCustomArguments()
        {
            ...
            {
                Debug.LogError("CommandLineReader.cs - GetCustomArguments() - Can't retrieve any custom arguments in the command line [" + commandLineArgs +
                               "]. Exception: " + e);
        ...
        public static string GetCustomArgument(string argumentName)
        {
            ...
            {
                Debug.LogError("CommandLineReader.cs - GetCustomArgument() - Can't retrieve any custom argument named [" + argumentName +
                               "] in the command line [" + GetCommandLine() + "].");
                return "";
            }
        }
    }
