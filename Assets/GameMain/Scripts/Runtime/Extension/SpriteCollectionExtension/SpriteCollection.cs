...
{
    [CreateAssetMenu(fileName = "SpriteCollection", menuName = "Game Framework/SpriteCollection", order = 0)]
#if ODIN_INSPECTOR
    public class SpriteCollection : SerializedScriptableObject
    {
        ...
        protected override void OnBeforeSerialize()
        {
            ...
            {
                m_AtlasFolder = SettingsUtils.FrameworkGlobalSettings.AtlasFolder;
            }
        }
...
public class SpriteCollectionEditor : Editor {
    public override void OnInspectorGUI() {
        ...
        SpriteCollection myScript = (SpriteCollection)target;
        if(GUILayout.Button("Create Atlas")) {
            myScript.CreateAtlas();
            myScript.Pack();
        }
    }
}
